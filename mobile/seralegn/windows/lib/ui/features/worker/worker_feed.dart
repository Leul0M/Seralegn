              ...
              children: [
                ...
                if (job.description != null && job.description!.isNotEmpty) ...[
                  Text(
                    ...
                    style: const TextStyle(color: AppTheme.textLight, fontSize: 14, height: 1.3),
                  ),
                  const SizedBox(height: 12),
                ],
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              const Icon(Icons.location_on_rounded, size: 15, color: AppTheme.textLight),
                              const SizedBox(width: 4),
                              Text(
                                distance > 0 ? '${distance.toStringAsFixed(1)} km away' : 'Location available',
                    ...
                    if (showApplyButton)
                      ElevatedButton(
                        onPressed: () => _showJobDetailsBottomSheet(job, distance),
                        style: ElevatedButton.styleFrom(
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    job.title,
                    style: theme.textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold, color: AppTheme.neutralDark),
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        distance > 0 ? '${distance.toStringAsFixed(1)} km away' : 'Location coordinates hidden',
                  ...
                  const Text(
                    'Job Description',
                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: AppTheme.neutralDark),
                  ),
                  const SizedBox(height: 8),
                  Text(
                  ...
                  if (job.locationLat != null && job.locationLng != null) ...[
                    ...
                    ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        child: FlutterMap(
                          options: MapOptions(
                            initialCenter: LatLng(job.locationLat!, job.locationLng!),
                            initialZoom: 14.0,
                          ),
                          children: [
                            TileLayer(
                            ...
                            MarkerLayer(
                              markers: [
                                Marker(
                                  point: LatLng(job.locationLat!, job.locationLng!),
                                  child: const Icon(
                                    Icons.location_pin,
                                    color: Colors.red,
                                    size: 32,
      ...
      return Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.search_off_rounded, size: 72, color: Color(0xFFE2F0EA)),
              const SizedBox(height: 16),
              const Text(
              ...
              const SizedBox(height: 8),
              const Text(
                'Check back later! New homeowner jobs appear automatically in the feed.',
                textAlign: TextAlign.center,
      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          suffixIcon: Container(
            ...
            child: const Icon(Icons.tune_rounded, color: AppTheme.primaryGreen, size: 20),
          ),
          filled: true,
          ...
          border: OutlineInputBorder(
            ...
            borderSide: const BorderSide(color: AppTheme.cardBorderColor, width: 1.5),
          ),
