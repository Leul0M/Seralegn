...
class _WorkerDashboardState extends State<WorkerDashboard> {
          ...
          children: [
            ...
            Center(
              child: CircleAvatar(
                ...
                child: Icon(Icons.construction_rounded, size: 48, color: theme.colorScheme.secondary),
              ),
            ),
            ...
            _buildProfileDetailRow(Icons.phone, 'Phone Number', _worker!.phoneNumber),
            const Divider(),
            _buildProfileDetailRow(
              Icons.verified_user,
              'Fayda Verification',
              _worker!.faydaVerified ? 'Verified' : 'Pending Verification',
              color: _worker!.faydaVerified ? AppTheme.actionGreen : Colors.orange,
            ),
            const Divider(),
            _buildProfileDetailRow(
            ...
            OutlinedButton.icon(
              ...
              label: const Text('Switch to Homeowner Account'),
            ),
          ],
        ),
      ),
  ...
  Widget _buildProfileDetailRow(IconData icon, String label, String value, {Color? color}) {
    return Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          _currentIndex == 0 ? 'Seralegn' : 
          _currentIndex == 1 ? 'My Active Gigs' :
          _currentIndex == 2 ? 'Premium Membership' : 'Worker Profile',
          style: TextStyle(
            fontFamily: 'Roboto',
            fontWeight: FontWeight.bold,
            color: _currentIndex == 0 ? AppTheme.primaryGreen : AppTheme.neutralDark,
            fontSize: 22,
          ),
        ),
        actions: [
