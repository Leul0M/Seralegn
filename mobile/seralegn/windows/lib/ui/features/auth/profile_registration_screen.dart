...
class _ProfileRegistrationScreenState extends State<ProfileRegistrationScreen> {
  ...
  void _submitProfile() async {
    ...
    try {
      if (widget.role == UserRole.homeOwner) {
        await authRepo.registerHomeOwner(_nameController.text.trim());
        if (mounted) {
  ...
  Widget build(BuildContext context) {
    ...
    final isHomeOwner = widget.role == UserRole.homeOwner;

    return Scaffold(
      appBar: AppBar(
        title: Text(isHomeOwner ? 'Homeowner Profile' : 'Worker Profile'),
      ),
      body: SafeArea(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    isHomeOwner
                        ? 'Register as a homeowner to post repair tasks and find service providers.'
                  ...
                  ElevatedButton(
                    ...
                    child: _isLoading
                        ...
                        : Text(isHomeOwner ? 'Create Homeowner Account' : 'Create Worker Account'),
                  ),
                ],
              ),
            ),
