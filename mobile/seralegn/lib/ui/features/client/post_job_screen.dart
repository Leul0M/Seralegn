...
class _PostJobScreenState extends State<PostJobScreen> {
  ...
  LatLng _currentLocation = const LatLng(
    9.0300,
    38.7400,
  ); // Defaults to Addis Ababa center
  ...
  void _publishJob() async {
    ...
    final clientId = authRepo.currentUserId;
    if (clientId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Error: Client ID not found.')),
      );
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'Job published successfully! Workers can now claim it.',
            ),
