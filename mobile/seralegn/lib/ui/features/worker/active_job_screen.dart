  ...
  Future<void> _loadActiveJob() async {
    ...
    try {
      ...
      if (activeJobs.isNotEmpty) {
        ...
        final ho = await dbRepo.getClientProfile(job.clientId);
        setState(() {
          _client = ho;
        });
      } else {
          ...
          children: [
            ...
            Card(
              color: _activeJob!.status == 'claimed'
                  ...
                  ? AppTheme.actionGreen.withValues(alpha: 0.05)
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        onPressed: () => _callClient(_client!.phoneNumber),
                        icon: const Icon(
                          Icons.phone,
                          color: AppTheme.actionGreen,
                        ),
                        style: IconButton.styleFrom(
                          backgroundColor: AppTheme.actionGreen.withValues(
                            alpha: 0.1,
                          ),
                        ),
                        tooltip: 'Call Client',
            ...
            if (_activeJob!.locationLat != null &&
                _activeJob!.locationLng != null) ...[
              const Text(
                'Worksite Location',
                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16),
              ),
              ...
              ClipRRect(
                ...
                child: SizedBox(
                  ...
                  child: FlutterMap(
                    options: MapOptions(
                      center: LatLng(
                        _activeJob!.locationLat!,
                        _activeJob!.locationLng!,
                      ),
                      zoom: 15.0,
                    ),
                    children: [
              ...
              Container(
                ...
                child: const Column(
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      'The client has been notified to verify and release payment. You can call them to speed up the process.',
                      textAlign: TextAlign.center,
